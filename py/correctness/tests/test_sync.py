...
def test_changes_since():
    ...
    siteid = None
    expected = [
        ('user', b'\x01\t\x01', 'name', 'Javi', 1, 1, site_id, 1, 0, '1700000000'),
        ('deck', b'\x01\t\x01', 'owner_id', 1, 1, 1, site_id, 1, 1, '1700000000'),
        ('deck', b'\x01\t\x01', 'title', 'Preso', 1, 1, site_id, 1, 2, '1700000000'),
        ('slide', b'\x01\t\x01', 'deck_id', 1, 1, 1, site_id, 1, 3, '1700000000'),
        ('slide', b'\x01\t\x01', 'order', 0, 1, 1, site_id, 1, 4, '1700000000'),
        ('component', b'\x01\t\x01', 'type', 'text', 1, 1, site_id, 1, 5, '1700000000'),
        ('component', b'\x01\t\x01', 'slide_id', 1, 1, 1, site_id, 1, 6, '1700000000'),
        ('component', b'\x01\t\x01', 'content', 'wootwoot', 1, 1, site_id, 1, 7, '1700000000'),
        ('component', b'\x01\t\x02', 'type', 'text', 1, 1, site_id, 1, 8, '1700000000'),
        ('component', b'\x01\t\x02', 'slide_id', 1, 1, 1, site_id, 1, 9, '1700000000'),
        ('component', b'\x01\t\x02', 'content', 'toottoot', 1, 1, site_id, 1, 10, '1700000000'),
        ('component', b'\x01\t\x03', 'type', 'text', 1, 1, site_id, 1, 11, '1700000000'),
        ('component', b'\x01\t\x03', 'slide_id', 1, 1, 1, site_id, 1, 12, '1700000000'),
        ('component', b'\x01\t\x03', 'content', 'footfoot', 1, 1, site_id, 1, 13, '1700000000'),
        ('slide', b'\x01\t\x02', 'deck_id', 1, 1, 1, site_id, 1, 14, '1700000000'),
        ('slide', b'\x01\t\x02', 'order', 1, 1, 1, site_id, 1, 15, '1700000000'),
        ('slide', b'\x01\t\x03', 'deck_id', 1, 1, 1, site_id, 1, 16, '1700000000'),
        ('slide', b'\x01\t\x03', 'order', 2, 1, 1, site_id, 1, 17, '1700000000')
    ]
    ...
    assert (rows == [('user', b'\x01\x09\x01', 'name', "Maestro", 2, 2, site_id, 1, 0, '1700000000'),
                     ('deck', b'\x01\x09\x01', 'title', "Presto", 2, 2, site_id, 1, 1, '1700000000')])
...
def test_delete():
    ...
    assert (rows == [('component', b'\x01\x09\x01',
            '-1', None, 2, 2, site_id, 2, 0, '1700000000')])
    ...
    assert (rows == [('user', b'\x01\t\x01', 'name', 'Javi', 1, 1, site_id, 1, 0, '1700000000'),
                     ('component', b'\x01\t\x01', '-1', None, 2, 2, site_id, 2, 0, '1700000000'),
                     ('component', b'\x01\t\x02', '-1', None, 2, 3, site_id, 2, 0, '1700000000'),
                     ('component', b'\x01\t\x03', '-1', None, 2, 3, site_id, 2, 1, '1700000000'),
                     ('deck', b'\x01\t\x01', '-1', None, 2, 3, site_id, 2, 2, '1700000000'),
                     ('slide', b'\x01\t\x01', '-1', None, 2, 3, site_id, 2, 3, '1700000000'),
                     ('slide', b'\x01\t\x02', '-1', None, 2, 3, site_id, 2, 4, '1700000000'),
                     ('slide', b'\x01\t\x03', '-1', None, 2, 3, site_id, 2, 5, '1700000000')])
...
def test_merging_larger_backfilled_default():
    ...
    assert (changes == [('foo', b'\x01\t\x01', 'b', 4, 1, 1, site_id, 1, 0, '1700000000')])
...
def test_db_version_moves_as_expected_post_alter():
    ...
    site_id = get_site_id(db)
    assert (changes == [('foo', b'\x01\t\x01', 'b', 2, 1, 1, site_id, 1, 0, '1700000000'),
                        ('foo', b'\x01\t\x02', 'b', 3, 1, 2, site_id, 1, 0, '1700000000'),
                        ('foo', b'\x01\t\x02', 'c', 4, 1, 2, site_id, 1, 1, '1700000000'),
                        ('foo', b'\x01\t\x03', 'b', 4, 1, 3, site_id, 1, 0, '1700000000'),
                        ('foo', b'\x01\t\x03', 'c', 5, 1, 3, site_id, 1, 1, '1700000000'),
                        ('foo', b'\x01\t\x04', 'b', 4, 1, 4, site_id, 1, 0, '1700000000'),
                        ('foo', b'\x01\t\x04', 'c', 5, 1, 4, site_id, 1, 1, '1700000000')])
...
def test_merging_on_defaults2():
    ...
    assert (changes == [('foo', b'\x01\t\x01', 'b', 4, 1, 1, site_id1, 1, 0, '1700000000'),
                        ('foo', b'\x01\t\x01', 'c', 3, 1, 1, site_id2, 1, 1, '1700000000')])
    ...
    assert (changes == [
        ...
        ('foo', b'\x01\t\x01', 'b', 4, 1, 1, site_id1, 1, 0, '1700000000'),
...
def test_merge_larger_clock_larger_value():
    ...
    changes = db2.execute("SELECT * FROM crsql_changes").fetchall()
    site_id = get_site_id(db1)
    assert (changes == [('foo', b'\x01\t\x01', 'b', 3, 2, 2, site_id, 1, 0, '1700000000')])
...
def test_merge_larger_clock_smaller_value():
    ...
    changes = db2.execute("SELECT * FROM crsql_changes").fetchall()
    site_id = get_site_id(db1)
    assert (changes == [('foo', b'\x01\t\x01', 'b', 0, 2, 2, site_id, 1, 0, '1700000000')])
...
def test_merge_larger_clock_same_value():
    ...
    site_id = get_site_id(db1)
    changes = db2.execute("SELECT * FROM crsql_changes").fetchall()
    assert (changes == [('foo', b'\x01\t\x01', 'b', 2, 2, 2, site_id, 1, 0, '1700000000')])
